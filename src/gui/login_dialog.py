...
from PySide6.QtWidgets import (
    QApplication, QDialog, QLineEdit, QPushButton, QVBoxLayout, QLabel, QMessageBox
)
...
class LoginDialog(QDialog):
    ...
    def handle_login(self):
        ...
        if not self.totp_secret:
            QMessageBox.critical(self, "Configuration Error", "TOTP secret is not configured. Please set it in the Settings tab.")
            self.reject()
            return
...
if __name__ == '__main__':
    ...
    dialog = LoginDialog(totp_secret=test_secret)
